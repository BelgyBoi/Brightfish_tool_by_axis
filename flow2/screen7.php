      ...
      <div class="grid" style="margin-top: 40px;">
        <div class="moviess">
          <div class="poster-wrapper">
            <img src="<?= IMAGES_URL ?>movies/Dog man.svg" alt="Dog man">
          </div>
          <div class="title-info">
            <p>Dog man</p>
          </div>
          <p style="text-align:center; font-size: 14px;">27/05/2025-03/06/2025<br>Price range: €500–€750</p>
        </div>
        <div class="moviess">
          <div class="poster-wrapper">
            <img src="<?= IMAGES_URL ?>movies/Minecraft.svg" alt="Minecraft movie">
          </div>
          <div class="title-info">
            <p>Minecraft movie</p>
          </div>
          <p style="text-align:center; font-size: 14px;">04/06/2025–10/06/2025<br>Price range: €550–€700</p>
        </div>
        <div class="moviess">
          <div class="poster-wrapper">
            <img src="<?= IMAGES_URL ?>movies/Sinner.svg" alt="Sinners">
          </div>
          <div class="title-info">
            <p>Sinners</p>
          </div>
          <p style="text-align:center; font-size: 14px;">04/06/2025–10/06/2025<br>Price range: €500–€600</p>
        </div>
      </div>
